...
[discuss with us](https://github.com/singularitti/FermiDiracOperatorExpansion.jl/discussions).

If you have additional tips, please either
[report an issue](https://github.com/singularitti/FermiDiracOperatorExpansion.jl/issues/new) or
[submit a pull request](https://github.com/singularitti/FermiDiracOperatorExpansion.jl/compare) with suggestions.
